...
#logms = np.log2(ms/50)
names = ['AdaLazyCtnPCSA-2.91-1.5-1', 'UnifOffsPCSA-200-2.0', 'LowestZeroCtn-300-2.0-1.5-3', 'SecondHighCtn-300-3.0-1.5-3']

Round = 25000
df1 = pd.read_csv("results/T22/V07242348_OnlyLast_differences_07_25_03_01_05.csv")
