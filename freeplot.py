...
names = ["LL", "Thrs-2.0-6", "Thrs-4.0-6", "Thrs-8.0-6","Thrs-16.0-6", "Thrs-32.0-6"]
...
AllDf = pd.read_csv("results/Congregated_Mtg_3bit_06_24_01_31_17.csv") # graph of 3 bits, Mtg
...
for i in range(len(names)):
    ...
    plt.plot(expsamplx[250:], relativeVar[250:], color=color, label=name)
